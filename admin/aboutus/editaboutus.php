    ...
    $error  ['cpasserror'] =  "please enter your Confirm Password  ";
      ...
      if ($photo['name']) {
        ...
        if (file_exists($filepath)) {
            ...
            $query = " UPDATE aboutus SET header='$header',title='$title',description='$description',description2='$description2',button_text='$button_text', button_url='$button_url', photo='$photoname' WHERE id = $id";  
            $send = mysqli_query($conntion,  $query);   
}

 else {
    $query = "UPDATE aboutus SET header='$header',title='$title',description='$description',description2='$description2',button_text='$button_text', button_url='$button_url' WHERE id = $id";
